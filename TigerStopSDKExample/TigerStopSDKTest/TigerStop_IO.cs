...
namespace TigerStopSDKExample
{
    public class TigerStop_IO : TigerStop_Com
    {
        ...
        //  =  =  =  CONSTRUCTORS  =  =  =
        public TigerStop_IO(int baud, string comPort) : base(baud, comPort)
        {
            OpenPort();
        ...
        // --- public static Dictionary<string, int>[] FindConnections() ---
        /// <summary>
        ...
        /// </summary>
        /// <param name="settingName"> An 'int' the represents the index of the setting to change. </param>
        ...
        /// </summary>
        /// <param name="ioNum"> An 'int' denoting which IO connection, 1 - 12, on the IO panel to change. If 'ioNum' is outside of the range 1 - 12, it is treated as 1. </param>
